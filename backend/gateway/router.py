...
async def chat_completions(
    ...
    asyncio.ensure_future(save_log(db, RequestLog(
        ...
        messages=[{"role": m.role, "content": m.content} for m in body.messages] + [{"role": "assistant", "content": result.content}],
...
async def _stream_response(
    ...
    asyncio.ensure_future(save_log(db, RequestLog(
        ...
        messages=[{"role": m.role, "content": m.content} for m in internal_request.messages] + [{"role": "assistant", "content": "".join(full_content)}],
